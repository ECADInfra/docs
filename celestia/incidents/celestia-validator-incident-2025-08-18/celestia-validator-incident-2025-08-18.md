...
## August 18-19, 2025 - Two Separate Network-Wide Consensus Issues

### Executive Summary
This report documents two distinct incidents that occurred on August 18, 2025, affecting our Celestia validator node. Both incidents were characterized by network-wide consensus coordination issues rather than isolated infrastructure problems. Our proactive monitoring, and timely responses enabled effective incident resolution.

**Key Findings:**
- **First Incident (15:30-18:00 UTC / 08:30-11:00 PDT)**: Network-wide validator updates to v5.0.2 causing peer instability
- **Second Incident (23:15-02:43 UTC / 16:15-19:43 PDT)**: Network-wide consensus performance degradation affecting multiple validators (spans August 18-19 UTC)
- **Root Cause**: Both incidents were network coordination issues, not infrastructure failures
- **Resolution**: First incident resolved by v5.0.2 upgrade, second incident resolved by natural network recovery

---

## INCIDENT 1: Network-Wide Validator Updates (15:30-18:00 UTC / 08:30-11:00 PDT)
...
- **Impact**: Blocks being missed due to abnormally high consensus "Timed out" message durations
...
- **16:00-17:50 UTC / 09:00-10:50 PDT**: Consistent missed blocks, often 1-2 per 10-minute period
...
- **Network Impact**: Indicates network-wide coordination issues, not isolated problems

### Our Analysis and "Guesses"

#### **Root Cause Hypothesis: Network-Wide Validator Updates**
...
### Lessons Learned
1. **Network Coordination**: Major version updates can cause network-wide coordination issues
...
## INCIDENT 2: Network-Wide Consensus Performance Degradation (23:15-02:43 UTC / 16:15-19:43 PDT) - Spans August 18-19 UTC
...
- **Network Impact**: Confirms network-wide consensus issue affecting multiple validators

### Our Analysis and "Guesses"

#### **Root Cause Hypothesis: Network-Wide Consensus Coordination Issue**
**Evidence Supporting This:**
- **Multiple Validators Affected**: 47 missing validators indicates network-wide problem
...
- **Network-Wide Pattern**: Multiple validators affected simultaneously
- **Timing**: Resolution occurred during network-wide improvement

### Lessons Learned
1. **Network-Wide Issues**: Consensus problems can affect multiple validators simultaneously
...
### Evidence Supporting Network-Wide Issues
...
#### **Second Incident**
- **47 Missing Validators**: Confirms network-wide impact
...
- **Peer Stability**: Network-wide peer connection issues
...
- **`celestia_consensus_missing_validators`**: Identified network-wide impact (up to 47 validators)
...
- **23:15-00:30 UTC / 16:15-17:30 PDT**: Monitoring showed network-wide impact
...
#### **Short Term**
1. **Automated Detection**: Develop alerts for network-wide consensus issues
...
3. **Network Health**: Participate in network-wide health monitoring initiatives
...
Both incidents on August 18-19, 2025, were characterized by network-wide consensus coordination issues rather than isolated infrastructure problems. Our proactive monitoring, data-driven decision making, and timely responses enabled effective incident resolution.
